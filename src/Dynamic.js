...
export default function Dynamic() {
  return (
    <div className="dynamic">
      <div className="p-1 col-md-3 col-12 componentBox3">
        <svg
          stroke="currentColor"
          fill="currentColor"
          stroke-width="0"
        ...
        <br />
        <div className="icon-info">Well-structured and effective code</div>
      </div>
      <div className="p-1 col-md-3 col-12 componentBox3 ">
        <svg
          stroke="currentColor"
      ...
      <div className="p-1 col-md-3 col-12 componentBox3">
        ...
        <br />
        <div className="icon-info">Dynamic websites that come to life</div>
      </div>
    </div>
  );
}
