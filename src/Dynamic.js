...
export default function Dynamic() {
    return (
        ...
        <div className="p-1 col-md-3 col-12"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
         color="#1a344d" height="80px" width="80px" xmlns="http://www.w3.org/2000/svg">
       ...
       <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" color="#1a344d" height="80px" width="80px" xmlns="http://www.w3.org/2000/svg">
